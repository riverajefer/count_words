...
function locationInfo() {
    ...
    this.getCities = function(id) {
        ...
        call.send(data, url, method, function(data) {
            ...
            if(lang==='es') {
                jQuery('.cities').find("option:eq(0)").html("Seleccione Ciudad");
            } else {
    ...
    this.getStates = function(id) {
        ...
        call.send(data, url, method, function(data) {
            ...
            if(lang==='es') {
                jQuery('.states').find("option:eq(0)").html("Seleccione Departamento");
            }else{
    ...
    this.getCountries = function() {
        ...
        call.send(data, url, method, function(data) {
            ...
            if(lang==='es') {
                jQuery('.countries').find("option:eq(0)").html("Seleccione Pais");
            }else{
